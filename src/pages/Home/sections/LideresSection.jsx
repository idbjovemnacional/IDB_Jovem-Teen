  ...
  return (
    <div className="flex flex-col items-center">
      <div className={`w-[120px] h-[120px] md:w-[150px] md:h-[150px] rounded-2xl mb-4 overflow-hidden ${isPast ? 'bg-[#D2691E]' : 'bg-[#E85A1B]'}`}>
        {leader.imagem_url ? (
          <img src={leader.imagem_url} alt={leader.nome} className="w-full h-full object-cover mix-blend-overlay opacity-80" />
        ) : null}
      </div>
...
export default function LideresSection() {
  ...
  const currentLeaders = lideres.filter(l => !l.is_antigo);
